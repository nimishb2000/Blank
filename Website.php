    ...
    <body class="x">
        <form method="post" name="form1">
            <div class="x1">
                <table border="0" class="x2">
                    <tr>
                        ...
                        <td class="x7"><input type="submit" class="x4" value="Log In" name="bt1" formaction="<?php echo $_SERVER['PHP_SELF']; ?>"></td>
                    </tr>
                </table>
            </div>
            ...
            <div style="width: 40%; height: 100%; float: right;"><br>
                ...
                <br><br>
                <input type="submit" name="bt2" value="Create Account" class="x13" formaction="<?php echo $_SERVER['PHP_SELF']; ?>">
            </div>
        </form>
    </body>
</html>